...
const Contacts = ({ user, authLoading }) => {
    ...
    useEffect(() => {
        ...
        if (!user) {
            // Khi ProtectedLayout đã chặn user, logic này chỉ là dự phòng
            setError("Lỗi: Bạn cần đăng nhập để xem danh sách này.");
        ...
        const fetchContacts = async () => {
            try {
                ...
                setError("Không thể tải dữ liệu. Vui lòng kiểm tra quyền hạn.");
            } finally {
                setLoadingData(false);
            }
        };
